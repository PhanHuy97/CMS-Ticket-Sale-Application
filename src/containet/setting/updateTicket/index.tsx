import { Checkbox, Col, Image, Input, Row, Select } from "antd";
...
function UpdateTicket({ exists }: UpdateTicketType) {
  const { Option } = Select;
  return (
    <div className={style.modal} onClick={exists}>
      ...
      >
        ...
        <Row>
          <Col flex="1">
            <Row style={{ marginBottom: 5 }}>
              <span className={style.label}>Mã sự kiện </span>
              <span
            ...
            <Input placeholder="Mã sự kiện" className={style.input} />
          </Col>
          <Col flex="1">
            <Row style={{ marginBottom: 5 }}>
              <span className={style.label}>Tên sự kiện </span>
            </Row>
            <Input
        ...
        <Select
          ...
          bordered={false}
          suffixIcon={<Image src={down} className={style.icon} />}
        >
